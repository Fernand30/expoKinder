            ...
            <View style={styles.spaceView}>
              <View style={styles.rowView}>
                ...
                <View style={styles.underLineView}>
                  ...
                  <TextInput underlineColorAndroid='transparent' placeholder='you@email.com' style={styles.textInput}/>
                </View>
              </View>
              <View style={styles.rowView}>
                ...
                <View style={styles.underLineView}>
                  ...
                  <TextInput underlineColorAndroid='transparent' placeholder='•••• •••• •••• ••••' secureTextEntry={true} style={styles.textInput}/>
                </View>
              </View>
              <View style={styles.rowView}>
                ...
                <View style={styles.underLineView}>
                  ...
                  <TextInput underlineColorAndroid='transparent' placeholder='MM / YY' style={styles.textInput}/>
                </View>
                <View style={styles.leftLineView}>
                  <Image source={Images.cvs} style={styles.cvs}/>
                  <Text style={styles.blackcvsText}>cvs</Text>
                  <TextInput underlineColorAndroid='transparent' placeholder='123' style={styles.textInput}/>
                </View>
              </View>
              <View style={styles.rowView}>
