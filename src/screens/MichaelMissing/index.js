...
class Welcome extends Component {
  ...
  goNewKinder(){
    this.props.navigation.navigate('NewKinder')
  }
    ...
    const { navigate } = this.props.navigation;
      ...
      <MyStatusBar backgroundColor="white"/>
          ...
          <View style={styles.marginSecondView}>
            <Text style={styles.codeText}>Is Michael missing?</Text>
            <View style={styles.rowView}>
              <TouchableOpacity onPress={this.goNewKinder.bind(this)} style={styles.redButton}>
